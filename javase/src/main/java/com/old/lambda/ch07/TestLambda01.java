...
public class TestLambda01 {
    ...
    public void test03() {
        //顺序流
        final List<Person> collect = people.stream().collect(Collectors.toList());
        //并行流
        final List<Person> collect1 = people.stream().parallel().collect(Collectors.toList());
    }
